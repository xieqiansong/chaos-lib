...
// 对后端请求做 200ms 防抖：持续输入时不断顺延，停止输入 200ms 后才真正请求
  ...
  <div class="home">
    ...
    <div class="panels-row">
      ...
      <div class="panel-col">
        <div class="section-toolbar">
          ...
          <div class="section-actions">
            ...
            <el-button
                ...
                type="primary"
                :icon="Refresh"
                :loading="frequentLoading || bookmarksLoading"
                @click="loadFrequent(); loadBookmarks()"
            >
              刷新
            </el-button>
          </div>
        ...
        <div v-loading="frequentLoading || bookmarksLoading" class="hist-list">
