...
const usedIcons = {Clock, Coin, Collection, Connection, Delete, EditPen, Folder, HomeFilled, Link, MagicStick, Monitor, Moon, Odometer, Plus, Setting, Sort, Star, Sunny, Tickets}
